...
Returns the most recent and nearest reported sighting information with
...
- speciesCode:
  ...
  (required) Species code of the species of interest. Scientific names
  can be specified if wrapped around the
