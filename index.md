...
([`R.home()`](https://rdrr.io/r/base/Rhome.html)), your user’s home
directory (`Sys.getenv("HOME")`), or your current working directory
([`getwd()`](https://rdrr.io/r/base/getwd.html)). Remember that
.Renviron is loaded once when you start R, so if you add your API key to
the file you will have to restart your R session. See
[`?Startup`](https://rdrr.io/r/base/Startup.html) for more information
on R’s startup files.
...
(i.e. within the last 30 days) observations, although
[`ebirdfreq()`](https://docs.ropensci.org/rebird/reference/ebirdfreq.md)
does provide historical frequency of observation data. In contrast,
`auk` gives access to the full set of ~ 500 million eBird observations.
For most ecological applications, users will require `auk`; however, for
...
[`ebirdnotable()`](https://docs.ropensci.org/rebird/reference/ebirdnotable.md)

Recent observations of a species in a region:
[`ebirdregion()`](https://docs.ropensci.org/rebird/reference/ebirdregion.md)

Recent nearby observations:
[`ebirdgeo()`](https://docs.ropensci.org/rebird/reference/ebirdgeo.md)

Recent nearby observations of a species:
[`ebirdgeo()`](https://docs.ropensci.org/rebird/reference/ebirdgeo.md)

Nearest observations of a species:
[`nearestobs()`](https://docs.ropensci.org/rebird/reference/nearestobs.md)
